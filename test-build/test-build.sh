...
chmod 777 ./rancher-compose.yml
./rancher-compose.yml --access-key 7798EBA1969968CA8C3E  --secret-key Nhb2cFM7USih8Ssu7TosyH9izzWQ686diki17wDm -p python-redis-demo-build${BUILD_NUMBER} up -d
